...
public class ProcessView {
    public void view() {
        ...
        JudicialOffice judicialOffice = new JudicialOffice("juzgado 45", 2342, "Cesar",
            LocationApi.getCities("Cesar").get(0), "Municipal");

        NaturalPerson prosecutor = new NaturalPerson("Juan", "Piña", "Pacheco",
            "Pacheco", "21424234", IdTypes.CC);
        NaturalPerson judgeParty = new NaturalPerson("Cristiano", "Javier", "Ronaldo",
            "Messi", "213233532", IdTypes.CC);

        RecordMetadata recordMetadata = new RecordMetadata(judicialOffice.getDepartment(),
            judicialOffice.getCity(), 237485968574853529L, 3, true,
            judicialOffice, constitutionalActions);
        ...
        ProceedingsMetadata proceedingsMetadata = new ProceedingsMetadata(
            ...
            LocalDate.now(), LocalDate.now(), 1, 286, 1, 285, "PDF",
            5.8, "Electronico", "");
    ...
    public void showProceedingsMetadata(ProceedingsMetadata proceedingsMetadata) {
        ...
        System.out.printf("Página inicio: %d       Página fin: %d\n",
            proceedingsMetadata.getInitPage(), proceedingsMetadata.getLastPage());
